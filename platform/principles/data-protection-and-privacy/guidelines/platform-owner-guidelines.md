...
### **What kind of data does DIGIT handle?** <a href="#id-2et92p0" id="id-2et92p0"></a>
...
Any personal data collected and stored in DIGIT is encrypted, both in storage and transmission. When displayed, this [data is to be masked by default](broken-reference). Users can request to unmask data; if they have the appropriate authorisation, they will be able to view the unmasked data, and this request to unmask will be [<mark style="color:blue;">recorded in an audit log</mark>](#user-content-fn-2)[^2].
...
* Access control: Establish audited and controlled access for personally identifying data, including authentication and authorization mechanisms. Authorize individuals only if they have a legal basis and a [legitimate purpose to access the data](broken-reference).
