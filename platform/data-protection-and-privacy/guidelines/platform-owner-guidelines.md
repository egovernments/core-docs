...
Any personal data collected and stored in DIGIT is encrypted, both in storage and transmission. When displayed, this [data is to be masked by default](../../../focus-areas/privacy.md). Users can request to unmask data; if they have the appropriate authorisation, they will be able to view the unmasked data, and this request to unmask will be [<mark style="color:blue;">recorded in an audit log</mark>](#user-content-fn-2)[^2].
