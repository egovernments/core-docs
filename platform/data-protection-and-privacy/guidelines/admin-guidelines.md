...
* Access control: Establish audited and controlled access for personally identifying data, including authentication and authorization mechanisms. Authorize individuals only if they have a legal basis and a [legitimate purpose](../../../reference/data-security/signed-data-audit.md) to access the data.
...
### **B.2 Detailed Guidelines For Administrative Authority** <a href="#id-4d34og8" id="id-4d34og8"></a>
...
### **B.2.2 Stage 1 - Program kickoff** <a href="#u7fbjnxklmm" id="u7fbjnxklmm"></a>
...
#### **B.2.6.1 What happens in Stage 5** <a href="#kyep9xxv6c1z" id="kyep9xxv6c1z"></a>
