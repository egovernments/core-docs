...
DIGIT comes with configurable "CI as code", "Deploy as code", etc.. which can be utilised to set up the pipelines and deploy new modules. More on that in the steps below.
