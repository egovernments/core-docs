...
Once the [`gcloud`](https://cloud.google.com/sdk/install) CLI is installed create a service account following the steps below:
...
A _Google Service Account_ for the platform should be created. Refer to [Creating and managing service accounts](https://cloud.google.com/iam/docs/creating-managing-service-accounts). The result is a JSON file containing the fields
...
The private key is BASE64 containing the newlines as non-escaped strings _"\n”_. So to avoid the resulting troubles the machine controller expects the full service account encoded in BASE64.
