...
* Brief introduction Kubespray
* Pre-requisites for deployment using Kubespray
* Deployment steps
...
2. Few servers/hosts/VMs which we will use as our targets to deploy Kubernetes. I am using Ubuntu 18.04, and my servers each have 4GB ram and 2vCPUs. This is fine for my lab purposes, which I use to try out new things using Kubernetes. You need to be able to SSH into each of these nodes as root using the SSH key pair I mentioned above.
