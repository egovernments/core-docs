...
7. If you are building a new domain on the DIGIT platform, start with a clean slate with only basic UI modules. Fork the [quick start tag](https://github.com/egovernments/DIGIT-Frontend/releases/tag/quick-start-v1.0) from [DIGIT-Frontend](https://github.com/egovernments/DIGIT-Frontend). Start adding new UI modules as folders within the [micro-ui-internals folder](https://github.com/egovernments/DIGIT-Frontend/tree/master/micro-ui/web/micro-ui-internals).&#x20;
